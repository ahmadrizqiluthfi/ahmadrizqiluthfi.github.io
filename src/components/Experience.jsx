      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-10">
          ...
          <div>
            ...
            <p className="mt-2">
              Bertugas sebagai IT Helpdesk yang menangani berbagai proyek
              penting, seperti migrasi data PC/Laptop di PT. Takenaka,
              mendampingi pelaksanaan corrective maintenance jaringan fiber
              optic di PUSLITBANG Polri dari pihak penyedia, serta memberikan
              dukungan layanan ICT Helpdesk di PT. Bonecom Tricom dan PT. Toyota
              Boshoku Indonesia. Juga terlibat dalam implementasi aplikasi web
              dan penyusunan dokumen UAT Form untuk mendukung proses pengujian
              aplikasi.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-xl font-semibold">
              Intern – Divisi Transformasi, PT. Askrindo
            </h3>
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              sisi front-end dari website yang diminta.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="mt-2">
              ...
              (maintenance) perangkat lunak dan keras pada PC/laptop.
            </p>
          </div>
          ...
          <div>
            <h3 className="text-xl font-semibold">
              Pekerja Harian Lepas – Auditor, PT. POS Indonesia
            </h3>
            <p className="text-sm text-gray-400">Okt 2024 – Jan 2025</p>
            <p className="mt-2">
              Membuat data pendataan menggunakan Google Sheets, melakukan
